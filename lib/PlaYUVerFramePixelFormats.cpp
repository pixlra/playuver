...
const std::map<int, PlaYUVerPixFmtDescriptor> g_PlaYUVerPixFmtDescriptorsMap = {
    {
        PlaYUVerFrame::YUV420p,
        {
            "YUV420p",
